...
def get_lowest_common_ancestor(tree, first_node, second_node):
    ...
    if (first_node.data < tree.data) and (second_node.data < tree.data):
        return get_lowest_common_ancestor(tree.left, first_node, second_node)

    # go right if both are greater
    if (first_node.data > tree.data) and (second_node.data > tree.data):
        return get_lowest_common_ancestor(tree.right, first_node, second_node)

    # root will be the result for other scenarios
    return tree
